    ...
    <div className="site site-landing">
      ...
      <main id="main" className="site-main">
        ...
        <section className="site-how">
          ...
          <p>
            In a browser, open The Stall then Connect with Hub. Inside Nimiq Pay, the Mini App uses the wallet already in the
            app.
          </p>
        </section>
      </main>
        ...
        <div className="doc-graph">
          ...
          <div className="doc-row one">
            <article className="doc-node">
              ...
              <p>
                Closing Hub without signing is not a payment. Nothing leaves the wallet. If the account is empty, get
                NIM at{" "}
    ...
    <div className="site">
      ...
      <main id="main" className="site-main doc doc-wide intro-main">
        ...
        <div className="intro-actions">
          <button className="btn gold" type="button" onClick={() => router.push("/app")}>
            The Stall
            <Icon name="send" />
          </button>
        </div>
